       ...
       success: function(list){
            $.each(list, function(idx, response) {
               var stiRStts_1 = "<ul class='ulLftlst _data'>";
                   ...
                   stiRStts_1 += "<li class='w110px tAlgnCntr'>"+response.inconsistent_average+"%("+response.inconsistent_cnt+"건)</li>";
    ...
    success: function(list){
          $.each(list, function(idx, response) {
             var stiRStts_2 = "<ul class='ulLftlst _inDpthClr _grn _data'>";
                 ...
                 stiRStts_2 += "<li class='w110px'><span class='numTxt'></span><input type='text' name='' value='"+response.sum_currentamt+"' class='innmbr nmCmma _orm_amt'></li>";
                 ...
                 stiRStts_2 += "<li class='w85px tAlgnCntr'>"+response.avg_dueday+"</li>";
                 stiRStts_2 += "</ul>";
